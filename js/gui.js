...
GUI_control.prototype.switch_tab = function(tabName) {
    switch(tabName) {
        case 'advanced_tuning':
            TABS.advanced_tuning.initialize();
            break;
        case 'system_setup':
            TABS.system_setup.initialize();
            break;
        case 'io_monitor':
            TABS.io_monitor.initialize();
            break;
    }
}

$('.tab_advanced_tuning').on('click', function() {
    GUI.switch_tab('advanced_tuning');
});
$('.tab_system_setup').on('click', function() {
    GUI.switch_tab('system_setup');
});
$('.tab_io_monitor').on('click', function() {
    GUI.switch_tab('io_monitor');
});
